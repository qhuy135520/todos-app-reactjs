...
function CategoriesTableRow({ columns, children }) {
  return (
...
CategoriesTableRow.Header = Header
CategoriesTableRow.Row = Row
CategoriesTableRow.Body = Body
CategoriesTableRow.Footer = Footer
